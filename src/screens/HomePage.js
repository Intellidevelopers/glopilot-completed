...
import { StyleSheet, View, Text, TouchableOpacity, Image, ScrollView, Modal, Animated, Dimensions, ActivityIndicator, loading } from 'react-native';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.notificationContent}>
        <View style={styles.notificationTextContainer}>
          <Text style={styles.notificationTitle}>You have a new reservation!</Text>
      ...
      <View style={styles.reservationsContainer}>
        ...
        <View style={styles.tabsContainer}>
          <TouchableOpacity
            ...
            <Text style={[styles.tabButtonText, activeTab === 'current' && styles.activeTabText]}>Current (3)</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.tabButton, activeTab === 'upcoming' && styles.activeTab]}
            onPress={() => setActiveTab('upcoming')}>
            <Text style={[styles.tabButtonText, activeTab === 'upcoming' && styles.activeTabText]}>Upcoming (2)</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.tabButton, activeTab === 'completed' && styles.activeTab]}
            onPress={() => setActiveTab('completed')}>
            <Text style={[styles.tabButtonText, activeTab === 'completed' && styles.activeTabText]}>Completed (4)</Text>
          </TouchableOpacity>
        </View>
