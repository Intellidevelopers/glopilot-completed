...
const CheckInInstructionsScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Check-in Instructions</Text>
      </View>

      <View style={styles.body}>
        <Text style={styles.label}>Check-in Instructions</Text>
        <Text style={styles.subtitle}>Provide detailed check-in instructions for guests.</Text>
        <TextInput
          style={styles.input}
...
export default CheckInInstructionsScreen;
